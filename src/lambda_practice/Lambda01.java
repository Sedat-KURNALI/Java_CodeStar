...
//                kullanýmý yaygýndýr pratiktir.
//        Bir Stream içerisindeki verilerin teker teker iþlenmesidir. Teker teker iþleme sürecinde, bir önceki adýmda elde edilen sonuç
//        bir sonraki adýma girdi olarak sunulmaktadýr. Bu sayede yýðýlmlý bir hesaplama süreci elde edilmiþ olmaktadýr.
//                reduce metodu ilk parametrede identity deðeri, ikinci parametrede ise BinaryOperator türünden bir obj kullanýlýr.
//                reduce iþleminde bir önceki hesaplanmýþ deðer ile sýradaki deðer bir iþleme tabi tutulmaktadýr.
//        Ýþleme baþlarken bir önceki deðer olmadýðý için bu deðer identity parametresinde tanýmlanmaktadýr.
    ...
    // Task : List elelmanlarinin "W" ile baslamasýný kontrol ediniz.
    public static void basHarfiWIleBaslayan(List<String> yemek) {


    }

    // TODO Task : List elelmanlarinin "x" ile biten en az bir elemaý kontrol ediniz.
    ...
    public static void karkterEnFazla(List<String> yemek) {
        //limit(1) => Sýnýrlandýrma demek. Bu akýþýn elemanlarýndan oluþan, uzunluðu maxSize'dan uzun olmayacak
        // þekilde kesilmiþ bir akýþ return eder. Stream return eder.
        ...
        System.out.println(//sonIsim objesi data turu nedir -> Stream oldugu icin ben bunu arraya cevirmem gerekli
          ...
          /*
  TRÝCK : •    Stream'ler ekrana direk yazdýrýlamaz. Stream'i toArray() ile Array'e çeviririz.
  Array'i de Arrays.toString() 'in içine alýp yazdýrabiliriz.
•  Ör; System.out.println(Arrays.toString(***.toArray())); veya System.out.println(Arrays.asList(***.toArray()));
kullanýlabilir.

   */

    //TODO Task : list elemanlarini son harfine göre siralayýp ilk eleman hariç kalan elemanlari print ediniz.
